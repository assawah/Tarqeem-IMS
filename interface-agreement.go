...
var interfaceAgreementEnd = "/interface-agreement"
...
func interfaceAgreement() {
	E.GET(interfaceAgreementEnd, func(c echo.Context) error {
		return c.Render(http.StatusOK, "interface-agreement", nil)
	})

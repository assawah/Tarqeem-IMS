...
func (cu *CommentUpdate) AddIssueIDs(ids ...int) *CommentUpdate {
	cu.mutation.AddIssueIDs(ids...)
	return cu
}

// AddIssue adds the "issue" edges to the Issue entity.
func (cu *CommentUpdate) AddIssue(i ...*Issue) *CommentUpdate {
	ids := make([]int, len(i))
	for j := range i {
		ids[j] = i[j].ID
	}
...
func (cu *CommentUpdate) ClearIssue() *CommentUpdate {
	cu.mutation.ClearIssue()
	return cu
}

// RemoveIssueIDs removes the "issue" edge to Issue entities by IDs.
func (cu *CommentUpdate) RemoveIssueIDs(ids ...int) *CommentUpdate {
	cu.mutation.RemoveIssueIDs(ids...)
	return cu
}

// RemoveIssue removes "issue" edges to Issue entities.
func (cu *CommentUpdate) RemoveIssue(i ...*Issue) *CommentUpdate {
	ids := make([]int, len(i))
	for j := range i {
		ids[j] = i[j].ID
	}
...
func (cu *CommentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if cu.mutation.IssueCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   comment.IssueTable,
			Columns: comment.IssuePrimaryKey,
			Bidi:    false,
	...
	if nodes := cu.mutation.RemovedIssueIDs(); len(nodes) > 0 && !cu.mutation.IssueCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   comment.IssueTable,
	...
	if nodes := cu.mutation.IssueIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   comment.IssueTable,
...
// AddIssueIDs adds the "issue" edge to the Issue entity by IDs.
func (cuo *CommentUpdateOne) AddIssueIDs(ids ...int) *CommentUpdateOne {
	cuo.mutation.AddIssueIDs(ids...)
	return cuo
}

// AddIssue adds the "issue" edges to the Issue entity.
func (cuo *CommentUpdateOne) AddIssue(i ...*Issue) *CommentUpdateOne {
	ids := make([]int, len(i))
	for j := range i {
		ids[j] = i[j].ID
	}
...
// ClearIssue clears all "issue" edges to the Issue entity.
func (cuo *CommentUpdateOne) ClearIssue() *CommentUpdateOne {
	cuo.mutation.ClearIssue()
	return cuo
}

// RemoveIssueIDs removes the "issue" edge to Issue entities by IDs.
func (cuo *CommentUpdateOne) RemoveIssueIDs(ids ...int) *CommentUpdateOne {
	cuo.mutation.RemoveIssueIDs(ids...)
	return cuo
}

// RemoveIssue removes "issue" edges to Issue entities.
func (cuo *CommentUpdateOne) RemoveIssue(i ...*Issue) *CommentUpdateOne {
	ids := make([]int, len(i))
	for j := range i {
		ids[j] = i[j].ID
	}
...
func (cuo *CommentUpdateOne) sqlSave(ctx context.Context) (_node *Comment, err error) {
	...
	if nodes := cuo.mutation.RemovedIssueIDs(); len(nodes) > 0 && !cuo.mutation.IssueCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   comment.IssueTable,
	...
	if nodes := cuo.mutation.IssueIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   comment.IssueTable,
